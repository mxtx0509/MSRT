...
class SRDataset(data.Dataset):
    def __init__(self, feature_dir,json_dir, file_list,adj_size=40,graph_mode='same',Threshold=0.2):
    ...
    def __getitem__(self, index):
        ...
        adj_npy,feature_npy = build_graph(video_id,self.graph_mode,self.json_dir,self.feature_dir,self.Threshold)
